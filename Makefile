...
OBJECTS = anova.o anova_result.o array_utils.o correlation.o correlation_matrix.o cox.o fitting.o math_utils.o matrix.o p_adjust.o statistics.o stats_inference.o R_utils.o ttest.o ttest_result.o
